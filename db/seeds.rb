...
if Rails.env.test?
  ...
  User.create({ email: 'nazar@email.com', nickname: 'nazar', password: 'testtest', avatar: 'placeholder1.png',
                description: 'test desc' })
  User.create({ email: 'ivan@email.com', nickname: 'ivan', password: 'testtest', avatar: 'placeholder2.png',
